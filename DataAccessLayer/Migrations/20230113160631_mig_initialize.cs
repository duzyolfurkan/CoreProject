...
{
    public partial class mig_initialize : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AboutDatails1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AboutDatails2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
